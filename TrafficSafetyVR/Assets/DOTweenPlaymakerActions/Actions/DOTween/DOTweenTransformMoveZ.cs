...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformMoveZ : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOMoveZ(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Move Z - SUCCESS!");

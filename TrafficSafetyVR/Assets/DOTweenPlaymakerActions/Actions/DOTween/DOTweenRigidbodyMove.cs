...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbodyMove : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody>().DOMove(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RigidBody Move - SUCCESS!");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbody2DRotate : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody2D>().DORotate(toAngle.Value, duration.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RigidBody2D Rotate - SUCCESS!");

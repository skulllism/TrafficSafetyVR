...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLocalMoveX : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLocalMoveX(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Local Move X - SUCCESS!");

...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbody2DMoveX : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody2D>().DOMoveX(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RigidBody2D Move X - SUCCESS!");

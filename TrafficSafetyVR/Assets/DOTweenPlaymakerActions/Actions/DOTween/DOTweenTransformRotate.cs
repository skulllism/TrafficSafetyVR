...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformRotate : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DORotate(to.Value, duration.Value, rotateMode);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Rotate - SUCCESS!");

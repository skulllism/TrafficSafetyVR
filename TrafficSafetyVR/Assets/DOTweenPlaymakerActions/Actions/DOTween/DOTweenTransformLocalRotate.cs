...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLocalRotate : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOLocalRotate(to.Value, duration.Value, rotateMode);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Local Rotate - SUCCESS!");

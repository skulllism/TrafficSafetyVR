...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenRigidbodyRotate : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Rigidbody>().DORotate(to.Value, duration.Value, rotateMode);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween RigidBody Rotate - SUCCESS!");

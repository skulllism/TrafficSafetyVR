...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformMoveX : FsmStateAction
    {
        ...
        {
            tweener = Fsm.GetOwnerDefaultTarget(gameObject).GetComponent<Transform>().DOMoveX(to.Value, duration.Value, snapping.Value);
            ...
            if (debugThis.Value) Debug.Log("GameObject [" + State.Fsm.GameObjectName + "] FSM [" + State.Fsm.Name + "] State [" + State.Name + "] - DOTween Transform Move X - SUCCESS!");
